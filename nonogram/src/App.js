...
function App() {
  ...
  return (
    <div className="App">
      <button className = "rowTest" onClick = {() => genNums(true)}>Row Test</button>
      <button className = "colTest" onClick = {() => genNums(false)}>Col Test</button>

      <button className = "create" onClick = {createGrid}>CREATE!</button>
      <button className = "check" onClick = {checkGrid}>CHECK!</button>
